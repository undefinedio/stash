        ...
        value: function render() {
            function processMenuItem(menuItem, key) {
                ...
                return _react2.default.createElement(
                    ...
                    menuItem.children && menuItem.children.length ? _react2.default.createElement(
                        'ul',
                        { className: 'sub-menu' },
            ...
            var menuComponent = this.props.nav_menus[this.props.location].map(processMenuItem);
            return _react2.default.createElement(
                'ul',
...
var Post = function (_React$Component) {
	...
	_createClass(Post, [{
		key: 'render',
		value: function render() {
			var id = 'post-' + this.props.post.ID;
			return React.createElement(
				'article',
				{ id: id, className: this.props.post.post_class },
				React.createElement(
					'header',
					{ className: 'entry-header' },
					'single' === this.props.route ? React.createElement(
						'h1',
				...
				React.createElement('div', { dangerouslySetInnerHTML: { __html: this.props.post.twentysixteen_post_thumbnail } }),
				React.createElement('div', { className: 'entry-content', dangerouslySetInnerHTML: { __html: this.props.post.the_content } }),
				React.createElement('footer', { className: 'entry-footer', dangerouslySetInnerHTML: { __html: this.props.post.twentysixteen_entry_meta } }),
				React.createElement('div', { dangerouslySetInnerHTML: { __html: this.props.post.edit_link } })
			);
		}
	}]);
...
var _River = __webpack_require__(38);
...
var App = function (_React$Component) {
    ...
    function App(props) {
        ...
        _this.handleAllClickEvents = _this.handleAllClickEvents.bind(_this);
        return _this;
    }

    _createClass(App, [{
        key: 'handleAllClickEvents',
        value: function handleAllClickEvents(event) {

            var href = event.target.getAttribute('href');
            var apiUrl = this.props.template_tags.home_url + '/wp-json/nodeifywp/v1/route';
            var self = this;
        ...
        key: 'render',
        value: function render() {
            var initialStateString = 'window.__INITIAL_STATE__ = ' + includes.htmlescape(this.props) + ';';
            ...
            return React.createElement(
                ...
                React.createElement(
                    'div',
                    { onClick: this.handleAllClickEvents, className: 'site-inner' },
                    React.createElement(_Header2.default, this.props),
                    React.createElement(
                        'div',
                        { id: 'content', className: 'site-content' },
                        'single' === this.props.route.type || '404' === this.props.route.type ? React.createElement(
                            'div',
                            null,
                            'single' === this.props.route.type ? React.createElement(_Single2.default, this.props) : React.createElement(_2.default, null)
                        ) : React.createElement(_River2.default, this.props)
                    ),
                    React.createElement(_Footer2.default, this.props)
                ),
                React.createElement('div', { dangerouslySetInnerHTML: { __html: this.props.template_tags.wp_footer } }),
                React.createElement('script', { dangerouslySetInnerHTML: { __html: initialStateString } })
            );
        }
    }]);
...
exports.default = includes.ReactRedux.connect(mapStateToProps, mapDispatchToProps)(App);
...
var Missing404 = function (_React$Component) {
	_inherits(Missing404, _React$Component);

	function Missing404() {
		_classCallCheck(this, Missing404);

		return _possibleConstructorReturn(this, (Missing404.__proto__ || Object.getPrototypeOf(Missing404)).apply(this, arguments));
	}

	_createClass(Missing404, [{
		key: "render",
		value: function render() {
			return React.createElement(
				"div",
	...
	_createClass(Comments, [{
		...
		value: function render() {
			return React.createElement(
				...
				parseInt(this.props.post.comments_number) > 0 ? React.createElement(
					"div",
					null,
					React.createElement(
						"h2",
					...
					React.createElement("div", { dangerouslySetInnerHTML: { __html: this.props.post.comments_navigation } }),
					React.createElement("div", { dangerouslySetInnerHTML: { __html: this.props.post.comments_html } }),
					React.createElement("div", { dangerouslySetInnerHTML: { __html: this.props.post.comments_navigation } })
				) : '',
				React.createElement("div", { dangerouslySetInnerHTML: { __html: this.props.post.comment_form } })
			);
		}
	}]);
	...
	_createClass(Footer, [{
		...
		value: function render() {
			return React.createElement(
				...
				this.props.nav_menus.primary ? React.createElement(
					'nav',
					{ className: 'main-navigation', role: 'navigation', 'aria-label': 'Footer Primary Menu' },
					React.createElement(_NavMenu2.default, _extends({}, this.props, { className: 'primary-menu', location: 'primary' }))
				) : '',
				this.props.nav_menus.social ? React.createElement(
					'nav',
					{ className: 'social-navigation', role: 'navigation', 'aria-label': 'Footer Social Links Menu' },
					React.createElement(_NavMenu2.default, _extends({}, this.props, { className: 'social-links-menu', location: 'social' }))
				) : '',
				React.createElement(
					'div',
					{ className: 'site-info' },
					...
					React.createElement(
						...
						React.createElement(
							'a',
							{ href: this.props.template_tags.home_url, rel: 'home' },
							this.props.template_tags.bloginfo_name
						)
					),
					React.createElement(
						'a',
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement('div', { dangerouslySetInnerHTML: { __html: this.props.template_tags.twentysixteen_the_custom_logo } }),
							'home' === this.props.route.type ? React.createElement(
								'h1',
								{ className: 'site-title' },
								React.createElement(
									'a',
								...
								React.createElement(
									...
									this.props.template_tags.bloginfo_description
								)
							)
						),
						this.props.nav_menus.primary || this.props.nav_menus.social ? React.createElement(
							'div',
							null,
							React.createElement(
								'button',
								{ id: 'menu-toggle', className: 'menu-toggle' },
								'Menu'
							),
							React.createElement(
								'div',
								{ id: 'site-header-menu', className: 'site-header-menu' },
								this.props.nav_menus.primary ? React.createElement(
									'nav',
								...
								this.props.nav_menus.social ? React.createElement(
									'nav',
									{ id: 'social-navigation', className: 'social-navigation', role: 'navigation', 'aria-label': 'Social Links Menu' },
									React.createElement(_NavMenu2.default, _extends({}, this.props, { className: 'social-links-menu', location: 'social' }))
								) : ''
							)
						) : ''
...
var River = function (_React$Component) {
    ...
    function River() {
        ...
        return _possibleConstructorReturn(this, (River.__proto__ || Object.getPrototypeOf(River)).apply(this, arguments));
    }
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    this.props.posts.map(function (post, key) {
                        return React.createElement(_Post2.default, _extends({ key: key }, this.props, { post: post }));
                    }, this)
                )
            );
        }
...
var Sidebar = function (_React$Component) {
    ...
    _createClass(Sidebar, [{
        key: "render",
        value: function render() {
            return React.createElement("aside", { id: "secondary", className: "sidebar widget-area", role: "complementary", dangerouslySetInnerHTML: { __html: this.props.sidebars['sidebar-1'] } });
        }
    }]);
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    'main',
                    { id: 'main', className: 'site-main', role: 'main' },
                    React.createElement(_Post2.default, _extends({}, this.props, { post: this.props.posts[0] }))
                ),
                React.createElement(_Comments2.default, { post: this.props.posts[0] })
            );
        }
    }]);
...
var initialState = includes.immutable.Map({
...
var store = includes.redux.createStore(includes.reducer, initialState, includes.redux.applyMiddleware(includes.thunk));

print(includes.ReactDOMServer.renderToStaticMarkup(React.createElement(
  'html',
  null,
  React.createElement('head', { dangerouslySetInnerHTML: { __html: PHP.context.$template_tags.wp_head } }),
  React.createElement(
    'body',
    { className: PHP.context.$template_tags.get_body_class },
    React.createElement(
      'div',
      { className: 'nodeifywp-app-container' },
      React.createElement(
    ...
    React.createElement('script', { src: PHP.includes_js_url }),
    React.createElement('script', { src: PHP.client_js_url })
  )
)));
...
var _wrapActionCreators = __webpack_require__(68);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(13), __webpack_require__(89)(module)))
